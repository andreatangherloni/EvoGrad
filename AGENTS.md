...
- **Version Control:** Open Merge Requests against the appropriate target branch and follow the template in `.gitlab/merge_request_templates/default.md`. Tag MRs with the relevant issue number.
